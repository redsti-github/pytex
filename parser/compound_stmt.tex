...
% if_stmt:
%     | 'if' named_expression ':' block elif_stmt	TODO
%     | 'if' named_expression ':' block [else_block]
\def\@pytexParser@tryIfStmt{%
	\@pytexParser@joinSecond%
		{\@pytexParser@tryToken{\tokentypeIF}}% 'if'
		{\@pytexParser@join%
		...
		{\@pytexParser@tryElseBlock}%
		{%
			% we only have an if
			\e\def\e\@pytexTMP@parserReturnValue\e{\e\@pytexOperator@if\first}%
		}%
}
